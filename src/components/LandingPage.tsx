      ...
      <div className="landing-scale-outer">
        ...
        <div className="group-2">
          <div className="group-1">
            ...
            <div className="div15">Устройство теплого пола</div>
            <div className="div16">
              Профессиональный монтаж системы отопления под
              <br />
              стяжку. Экономия на обогреве до 30%.
            </div>
          </div>
        </div>
        ...
        <div className="_13">Делаем объект за 1 день</div>
        <div className="div29">Своя спецтехника и бригада</div>
        <div className="div30">Бесплатный выезд и замер сегодня</div>
        <div className="div31">Работа по договору подряда</div>
        <div className="div32">Скорость</div>
        <div className="div33">Ресурсы</div>
        <div className="div34">Сервис</div>
        ...
        <div className="div43">Адрес</div>
        <div className="rectangle-8" />
        <div className="info">info</div>
        <img className="image-7" src={image70} alt="" />
